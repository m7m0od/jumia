...
<div class="row forHeader">
    ...
    <div class="col-md-12">
        <div class=" w-25 text-center m-auto">
            <!--<img src="{{asset('uploads/1.png')}}" class="w-25 card-img-top" alt="...">-->
            <ion-icon class="iconNotFound" name="search-outline"></ion-icon>
            <h4>there is no result for " {{$keyword}} "</h4>
            ...
            <a href="{{url('/index')}}" class="btnOrangeee btn btn-info">Go To Homepage</a>
        </div>
    </div>
</div>
